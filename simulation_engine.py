...
class SimulationEngine:
    ...
    def __init__(
        ...
        female_mortality_multiplier: float = 1.2,
    ) -> None:
        """
        ...
        Args:
            ...
            female_mortality_multiplier: Multiplier applied to female mortality rates (default >1 to reduce longevity gap)
        """
        ...
        self.female_mortality_multiplier: float = female_mortality_multiplier
    ...
    def _get_mortality_rate(self, age_years: float, sex: str) -> float:
        ...
        # Apply an optional multiplier to female mortality rates (allows tuning of gender gap)
        if sex == "female":
            rate *= self.female_mortality_multiplier
