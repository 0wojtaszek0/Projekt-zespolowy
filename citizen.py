...
class Citizen:
    ...
    def compute_disability_score(self, disease_weights: Dict[str, float] | None = None) -> None:
        """
    ...
    def mortality_risk(
        ...
        """
        Calculate monthly mortality risk based on age, conditions, and disability.
        ...
        total_risk = age_factor + disease_factor
    ...
    def maybe_die(self, rng: random.Random | None = None) -> bool:
        """
    ...
    def maybe_give_birth(self, rng: random.Random | None = None) -> bool:
        """
